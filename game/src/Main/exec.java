...
public class exec {
	...
	private static void tudoOunada(String player, char ativo) {
		...
		//   numeros.get(i);
			...
			if(ativo == 's' || ativo == 's') {
				...
				System.out.println("\n\t-----------------------------------------------------------------------------------------------------------------");
				System.out.println("\t     [1][ELIMINAÇÃO: "+elim+"]        [2][PISTAS: "+pista+"]        [3][CHANCE: "+chance+"]               [LOJA: pressione L]");		
				System.out.println("\t-----------------------------------------------------------------------------------------------------------------");
			}
			...
			if(q == 10) {//------------------------------------------------------------------------------------------------------------------
		        ...
		        if(q == 20) {//------------------------------------------------------------------------------------------------------------------
					  System.out.println(questão+". Qual o pico mais alto do Brasil?"); // PREENCHER
	...
	private static void Sobre(String Player, int pontuacao) {
		...
		System.out.println("Este modo de jogo, consiste em levar o máximo de premios possíveis (Dinheiro). Quanto mais perguntas\nacertas"
				...
				+ " Porém, é possível contar com um número X de ajudas, para facilitar a vitória e comprar vantagens!");
